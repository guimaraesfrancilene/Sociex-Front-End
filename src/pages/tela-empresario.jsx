...
// Importação das imagens puxando da pasta correta de assets
...
function TelaEmpresario() {
  return (
    <main className="main-container">
      <header className="navbar">
        <div className="logo-topo">
          <img src={menulateralImg} alt="menu lateral" />
        </div>
      ...
      <section className="hero-section">
        ...
        <div className="search-container">
          ...
          <button className="btn-adicionar"> + Adicionar Projeto</button>
        </div>
      </section>
        ...
        <div className="projects-container-inner">
          ...
          <div className="projects-grid">
            ...
            <div className="project-card">
              ...
              <h3>Educa_App</h3>
              <p>
                O Educa App serve como uma plataforma digital de apoio à
                educação.
              </p>
              <button className="btn-visualizar">VISUALIZAR</button>
            </div>
