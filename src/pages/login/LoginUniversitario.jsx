...
import './LoginUniversitario.css'
import { FiMail, FiLock, FiEye, FiEyeOff } from 'react-icons/fi'

function LoginUniversitario() {
  ...
  function handleLogin() {
    if (email && senha) {
      navigate('/universitario/dashboard')
    } else {
      ...
      <div className="lado-direito">
        ...
        <div className="card">
          ...
          <div className="login-campo">
            <label>Informe seu email institucional</label>
          ...
          <p className="login-cadastro">
            Não tem conta?{' '}
            <Link to="/cadastro/universitario">Cadastre-se</Link>
          </p>
        </div>
      </div>
...
export default LoginUniversitario